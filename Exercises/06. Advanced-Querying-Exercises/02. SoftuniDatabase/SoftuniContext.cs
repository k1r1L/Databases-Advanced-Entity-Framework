namespace _02.SoftuniDatabase
{
    ...
    public partial class SoftuniContext : DbContext
    {
        ...
        public IEnumerable<ProjectInfo> GetProjectsByEmployee(string firstName, string lastName)
        {
            ...
            firstNameParam.Value = "Gail";
            lastNameParam.Value = "Erickson";
            var projects = this.Database.SqlQuery<ProjectInfo>
                ("[dbo].[usp_GetProjectsByEmployee] @firstName, @lastName", firstNameParam, lastNameParam);
